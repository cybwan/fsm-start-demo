...
.PHONY: up-scenarios-3.1.1.NL
up-scenarios-3.1.1.NL:
	./scripts/scenarios.3.1.1.NL.sh

.PHONY: down-scenarios-3.1.1
down-scenarios-3.1.1:
	export clusters="C1";make k3d-reset

.PHONY: up-scenarios-3.1.2.PL
up-scenarios-3.1.2.PL:
	./scripts/scenarios.3.1.2.PL.sh

.PHONY: up-scenarios-3.1.2.NL
up-scenarios-3.1.2.NL:
	./scripts/scenarios.3.1.2.NL.sh

.PHONY: up-scenarios-3.1.2.ML
up-scenarios-3.1.2.ML:
	./scripts/scenarios.3.1.2.ML.sh

.PHONY: down-scenarios-3.1.2
down-scenarios-3.1.2:
	export clusters="C1";make k3d-reset

.PHONY: up-scenarios-3.1.3.PL
up-scenarios-3.1.3.PL:
	./scripts/scenarios.3.1.3.PL.sh

.PHONY: up-scenarios-3.1.3.NL
up-scenarios-3.1.3.NL:
	./scripts/scenarios.3.1.3.NL.sh

.PHONY: down-scenarios-3.1.3
down-scenarios-3.1.3:
	export clusters="C1";make k3d-reset

.PHONY: up-scenarios-3.1.4.PL
up-scenarios-3.1.4.PL:
	./scripts/scenarios.3.1.4.PL.sh

.PHONY: up-scenarios-3.1.4.NL
up-scenarios-3.1.4.NL:
	./scripts/scenarios.3.1.4.NL.sh

.PHONY: down-scenarios-3.1.4
down-scenarios-3.1.4:
	export clusters="C1";make k3d-reset
...
.PHONY: up-scenarios-3.2.2.PL
up-scenarios-3.2.2.PL:
	./scripts/scenarios.3.2.2.PL.sh

.PHONY: up-scenarios-3.2.2.NL
up-scenarios-3.2.2.NL:
	./scripts/scenarios.3.2.2.NL.sh

.PHONY: down-scenarios-3.2.2
down-scenarios-3.2.2:
	export clusters="C1 C2 C3";make k3d-reset

.PHONY: up-scenarios-3.2.3.PL
up-scenarios-3.2.3.PL:
	./scripts/scenarios.3.2.3.PL.sh

.PHONY: up-scenarios-3.2.3.NL
up-scenarios-3.2.3.NL:
	./scripts/scenarios.3.2.3.NL.sh

.PHONY: down-scenarios-3.2.3
down-scenarios-3.2.3:
	export clusters="C1 C2 C3";make k3d-reset

.PHONY: up-scenarios-3.2.4.PL
up-scenarios-3.2.4.PL:
	./scripts/scenarios.3.2.4.PL.sh

.PHONY: up-scenarios-3.2.4.NL
up-scenarios-3.2.4.NL:
	./scripts/scenarios.3.2.4.NL.sh
...
up-scenarios-3.3.1.PL:
	./scripts/scenarios.3.3.1.PL.sh

.PHONY: up-scenarios-3.3.1.NL
up-scenarios-3.3.1.NL:
	./scripts/scenarios.3.3.1.NL.sh

.PHONY: down-scenarios-3.3.1
down-scenarios-3.3.1:
	export clusters="C1 C2 C3";make k3d-reset

.PHONY: up-scenarios-3.4.4.PL
up-scenarios-3.4.4.PL:
	./scripts/scenarios.3.4.4.PL.sh

.PHONY: up-scenarios-3.4.4.NL
up-scenarios-3.4.4.NL:
	./scripts/scenarios.3.4.4.NL.sh

.PHONY: down-scenarios-3.4.4
down-scenarios-3.4.4:
	export clusters="C1 C2 C3";make k3d-reset