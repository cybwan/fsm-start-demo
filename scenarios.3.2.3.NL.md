...
spec:
  httpAddr: http://$c1_nacos_cluster_ip:8761/nacos
...
spec:
  httpAddr: http://$c2_nacos_external_ip:8761/nacos
...
apiVersion: connector.flomesh.io/v1alpha1
metadata:
  name: c2-nacos-to-c2-derive-nacos
spec:
  httpAddr: http://$c2_nacos_cluster_ip:8761/nacos
  deriveNamespace: derive-nacos
  asInternalServices: true
  syncToK8S:
    enable: true
...
spec:
  httpAddr: http://$c3_nacos_external_ip:8761/nacos
  deriveNamespace: none
  syncToK8S:
    enable: false
  syncFromK8S:
...
spec:
  httpAddr: http://$c3_nacos_cluster_ip:8761/nacos
  deriveNamespace: derive-nacos
  asInternalServices: true
  syncToK8S:
    enable: true
